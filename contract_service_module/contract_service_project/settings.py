...
# Add the parent directory to sys.path so 'shared' can be imported
sys.path.append(str(BASE_DIR.parent))

SECRET_KEY = config('SECRET_KEY', default='django-insecure-contract-management-key')
DEBUG = True
ALLOWED_HOSTS = ['*']
...
ROOT_URLCONF = 'contract_service_project.urls'
...
WSGI_APPLICATION = 'contract_service_project.wsgi.application'
