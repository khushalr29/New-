...
from ..serializers.attendanceRegularizationSerializer import AttendanceRegularizationSerializer, AttendanceRegularizationListSerializer
...
class AttendanceRegularizationView(APIView):
    ...
    @log_activity(UserActivityLog.CREATE, 'Attendance Regularization')
