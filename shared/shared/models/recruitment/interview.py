...
class InterviewType(TenantModel):
    ...
    class Meta:
        ...
        unique_together = ('interview_type_name', 'company')

    def __str__(self):
        return self.interview_type_name
...
class InterviewRound(TenantModel):
    ...
    class Meta:
        ...
        unique_together = ('job', 'name', 'company')

    def __str__(self):
        return f"{self.job.job_title} - {self.name}"
...
class Interview(TenantModel):
    ...
    def __str__(self):
        return f"{self.candidate.first_name} - {self.round.name}"
